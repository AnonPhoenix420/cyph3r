...
func DisplayHUD(data models.IntelData, verbose bool) {
	// 1. IDENTITY HEADER (Surgical Alignment Fix)
	fmt.Printf("\n%s╔═══════════════════════════════════════════════════════════════╗", NeonBlue)
	...
	// IPv6 (Using your Cyan for that high-voltage look)
